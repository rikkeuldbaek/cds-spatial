...
```{r rhumb}
distRhumb(my_points)  # longer than the other ones 
```
...
```{r diff}
distMeeus(my_points) #shortest
distRhumb(my_points)  #longest 

# Calculate the difference in km
(distRhumb(my_points)-distMeeus(my_points))/1000# difference in km 711.3266

# Calculate percent difference
((distRhumb(my_points)-distMeeus(my_points))/distMeeus(my_points)*100) #4.404789 percentage difference
```
...
points_4326 <- points %>% 
  st_as_sf(coords = c("longitude", "latitude"), crs = 4326)  #make it an sf object
...
# difference
(euc_dist-geo_dist )/1000 # 5876.71
(euc_dist-geo_dist)/geo_dist*100   # 36.3732%
```
