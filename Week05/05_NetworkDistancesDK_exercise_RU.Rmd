...
st_area(midtjylland)-st_area( st_union(iso_driving, walking and bike))


#
wow nice top dollar <- st_difference(midtjylland, st_union(iso_driving, walking and bike)) #the output is just a polygon
